//! `build_adjacent_nodes` against a reference oracle over generated NUMA
//! node sets, covering both the stack and heap code paths.

use proptest::prelude::*;
use themis::{
    build_adjacent_nodes, build_node_to_index, build_processor_to_node, MemoryTier, NumaNode,
    NumaNodeId,
};

use super::{LOCAL_DISTANCE, REMOTE_DISTANCE};
